...
def main():
    ...
    # P3: Plotting
    plot_mca(varnorm,var1_modes_patterns,var1_modes_timeseries,var2_modes_patterns,var2_modes_timeseries,lon1,lat1,lon2,lat2,input_dict)
...
## P3: Plotting
def plot_mca(varnorm,var1_modes_patterns,var1_modes_timeseries,var2_modes_patterns,var2_modes_timeseries,lon1_2d,lat1_2d,lon2_2d,lat2_2d,input_dict):
