...
input_dict={'varname1':'siconc','season1':'winter','region1':'TotalArc','varname2':'psl','season2':'winter','region2':'TotalArc','year_start':2015,'year_end':2100}
...
def define_mca_inputs():
    ...
    [var1,var2,lon1,lon2,lat1,lat2,area1,area2] = load_input_vars(varname1,varname2,season1,season2,member_start,member_end) 
...
def load_input_vars(varname1, varname2, season1, season2, member_start, member_end):
    nmemb=np.arange(member_start,member_end+1,1)
    var1 = []; var2 = []
    area1 = compute_cell_area(varname1); area2 = compute_cell_area(varname2)
    for memb in nmemb:
        print(memb)
        [var1_memb, lon1, lat1] = load_var(memb,varname1,season1)
        [var2_memb, lon2, lat2] = load_var(memb,varname2,season2)
