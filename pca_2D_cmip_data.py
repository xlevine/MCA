...
def main():
    ...
    plot_pca_2D(varnorm,var1_modes_patterns,var1_modes_timeseries,lev1,lat1,var1_clim)
...
## P3: Plotting
def plot_pca_2D(varnorm,var1_modes_patterns,var1_modes_timeseries,lev1_2d,lat1_2d,var1_clim):
