...
from toolbox_cmip_data import convert_varglobal2D_to_vardomain1D, convert_vardomain1D_to_varglobal2D, compute_2D_var, convert_lev2D
...
#    lev1 = lev1/100;
    ...
    region1_zmean = np.nanmean(region1,axis=-1)
    [area1_2D, region1_2D] = compute_2D_var(area1_zmean, region1_zmean, lev1)
